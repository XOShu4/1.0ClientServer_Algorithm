...
public class Client {
    ...
    static HashMap <String, String> colori = new HashMap<String, String>();
    private static void riempiColori(){
        colori.put("black","\033[30m");
        colori.put("red","\033[31m");
        colori.put("green","\033[32m");
        colori.put("yellow","\033[33m");
        colori.put("blue","\033[34m");
        colori.put("white","\033[97m");
    }
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try (Socket socket = new Socket(hostName, portNumber);
            ...
            new Thread(t).start();
            dibStamp("Connessione con il server effettuata\nCOMANDI:\n/listaUtenti:\n/NomeUtente1/NomeUtenteN: msg\n/sendToAll: msg\n/Settings:\n/EXIT");
            ...
            try { // inizio presa in input messaggi utente. i comandi inseriti vengono smistati.
                while (!(userInput = stdIn.readLine()).equals("/EXIT")) {//uscita del utente e rimozione del username
                    if(userInput.equals("/EXIT")){
                        ...
                        dibStamp("/SetTerminalColor -> cambia colore al terminale.\n/SetUserColor -> cambia colore del tuo userName.\n/SetOutSpeed -> cambia velocita output");
                        switch (userInput = stdIn.readLine()) {
                            case "/SetTerminalColor":
                                dibStamp("scrivi il colore che preferisci tutto in minuscolo");
                                userInput = stdIn.readLine();
                                String scelta=colori.get(userInput);
                                if(scelta!=null){
                                    System.out.println(scelta+"scelta effettuata!");
                                    t.toTerminal.println("@sc@"+scelta);
                                }
                                break;
